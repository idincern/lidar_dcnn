...
# The only operation that occurs is a reshaping and a batch norm.
with tf.variable_scope('z2'):
    z2 = tf.reshape(z1,[-1, z2_h, 1, z2_c])
...
with tf.variable_scope('z11'):
    z11 = tf.reshape(z10, [batch_size, z10_h*z10_c])

# z12 - reduce to one dimension with linear combination
